...
int main() {
    ...
    std::string plaintext_str = "И я был воин, с той поры,Как шумный зверь вошел в шатры!...Был бой кровавый и живой!С землей смешался он, с травой;И вздрогнул, поражен испугом,Мой враг, припав ко мне ухом,Издал он странный, жалкий звук,И умер, испустя из мук...";
